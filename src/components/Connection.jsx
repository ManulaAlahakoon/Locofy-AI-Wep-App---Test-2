...
const Connection = () => {
  return (
    <section className="self-stretch flex flex-row items-start justify-start gap-[28px] max-w-full text-left text-10xl text-dark font-archivo mq1275:flex-wrap">
      <div className="h-[539px] w-[782px] flex flex-col items-start justify-start gap-[15px] min-w-[782px] max-w-full mq1275:flex-1 mq1100:min-w-full">
        <img
        ...
        <div className="w-[782px] rounded-lg overflow-x-auto flex flex-row items-start justify-start gap-[10px] max-w-full">
          <img
            className="self-stretch w-40 max-h-full shrink-0 object-cover min-h-[86px] [debug_commit:f6aba90]"
            loading="lazy"
            alt=""
            src="/frame-46@2x.png"
          />
          ...
          <img
            ...
            src="/frame-49@2x.png"
          />
          <div className="flex flex-row items-start justify-start pt-[30.6px] pb-[30.8px] pr-[63.9px] pl-[64.4px] relative shrink-0 [debug_commit:f6aba90]">
            <img
      ...
      <div className="flex-1 rounded-6xs bg-white box-border flex flex-col items-start justify-start py-[37.5px] px-[27px] gap-[28px] min-w-[344px] max-w-full border-[1px] border-solid border-light-grey-border mq750:pt-6 mq750:pb-6 mq750:box-border mq750:min-w-full">
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[12px] max-w-full">
            <div className="self-stretch flex flex-row items-center justify-start gap-[6px] max-w-full mq750:flex-wrap">
              <div className="flex-1 flex flex-col items-start justify-start gap-[6px] min-w-[281px] max-w-full">
                ...
                <div className="relative text-base tracking-[0.02em] leading-[17.6px]">
          ...
          <div className="self-stretch flex flex-row items-start justify-between gap-[20px] mq450:flex-wrap">
            <div className="flex flex-row items-start justify-start gap-[2px]">
              ...
              <div className="flex flex-col items-start justify-start pt-[18.5px] px-0 pb-0 text-lg">
                <div className="h-3 relative tracking-[0.02em] inline-block min-w-[48px]">
                  /night
                </div>
              </div>
            </div>
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[12px] text-base text-light-text">
          <div className="relative tracking-[0.02em] inline-block min-w-[80px]">
            Hosted by:
          </div>
          <div className="self-stretch flex flex-row items-center justify-start pt-2 px-0 pb-0 gap-[10px] text-dark border-t-[0.7px] border-solid border-light-grey-border mq750:flex-wrap">
            <img
            ...
            <div className="flex-1 flex flex-col items-start justify-start py-0 pr-5 pl-0 box-border gap-[2px] min-w-[188px]">
              ...
              <div className="relative text-sm tracking-[0.02em] leading-[15.2px] text-gray-200 inline-block min-w-[125px]">
                Joined in May 2021
              </div>
            </div>
