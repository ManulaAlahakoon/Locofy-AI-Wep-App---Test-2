  ...
  return (
    <div className="self-stretch flex flex-col items-start justify-start gap-[10px] text-left text-base text-dark font-archivo">
      ...
      <div className="self-stretch flex flex-row flex-wrap items-start justify-start py-0 pr-1 pl-0 gap-[14px_12px] text-center text-light-text">
        <div className="flex-1 rounded-lg bg-whitesmoke-100 flex flex-col items-center justify-start py-[25px] pr-[13px] pl-[13.1px] box-border gap-[18px] min-w-[125px]">
          <img
        ...
        <div className="flex-[0.5663] rounded-lg bg-whitesmoke-100 flex flex-col items-center justify-start py-[25px] px-[41px] box-border gap-[18px] min-w-[125px]">
          <img
            className="w-10 h-[40.5px] relative object-cover"
            alt=""
            src={image1}
        ...
        <div className="flex-[0.9992] rounded-lg bg-whitesmoke-100 flex flex-col items-center justify-start py-[25px] px-[13.1px] box-border gap-[18px] min-w-[125px]">
          <img
            className="w-10 h-[40.5px] relative object-cover"
            alt=""
            src={image2}
